    ...
    var setting = {
			...
			callback: {
				beforeClick: function(treeId, treeNode) {
					...
					$("#testIframe").attr("src","<%=basePath%>role/editView.do?roleId="+treeNode.id+"&rolePid="+treeNode.pId+"&roleName="+treeNode.type+"&roleDes="+treeNode.name);
					return true;
				},
